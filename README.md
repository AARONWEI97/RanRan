...
│   ├── music/      # 音乐播放器组件 (MusicPlayer)
│   ├── photos/     # 照片相关组件 (PhotoGrid, HolographicViewer, UploadModal, TimelineView)
│   ├── settings/   # 设置相关组件 (SettingsModal, TagsModal)
│   └── ui/         # 基础通用 UI 组件 (Button, Card, Input, Modal, Toast, CyberSkeleton, OnboardingGuide)
├── hooks/          # 自定义 Hooks
...
---
*文档生成于：2026-04-19 | 路线图更新于：2026-04-20 | Phase 5 完成于：2026-04-20*
